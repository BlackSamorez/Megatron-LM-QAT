...
def main():
    ...
    with torch.no_grad():        
        while current_run_step < 100: # while True:
            start = perf_counter()
    ...
    # --- Final Cleanup ---
    print_rank_0("Loop finished. Waiting for pending saves...")
    ...
    dist.barrier()
    sync_and_save_elastic(tracker if tracker else None, accumulated_chunks, progress_file)
    print_rank_0("Done.")
