...
#SBATCH --job-name=ap3b-distill-from8b-TOP256-long
...
TRAINING_STEPS=400_000  # total tokens = 400_000 * 4_194_304 = 1_677_721_600_000
...
EXP_NAME=ap3b-from8b-TOP256-long
